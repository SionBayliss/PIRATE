...
# subset loci list on loci present in a gene family
...
die " - ERROR: no blast file specified" if $ll  eq "";
...
# parse blast output
open LL, "$ll" or die " - could not open BLAST output\n";
while(<LL>){
...
print " - number of loci found in loci list = $no_found\n";
